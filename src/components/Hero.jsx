...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col py-4 md:py-2`}>
    <div className={`flex-1 ${style.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className="flex flex-row items-center py-[4px] px-4 bg-discount-gradient rounded-[10px] mb-2">
        ...
        <p className={`${style.paragraph} ml-2 flex gap-1 flex-wrap text-sm md:text-base`}>
          <span className="text-white">20%</span>
          <span className="break-words">Discount For</span>{" "}
      ...
      <p className={`${style.paragraph} max-w-[400px] mt-5`}>
